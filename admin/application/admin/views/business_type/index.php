     ...
     <section id="container" >       
       ...
       <?php echo $leftbar; ?>       
         ...
         <section class="wrapper">                   
           ...
           </i> <?php echo $module_name; ?><span class="add_button"><a data-toggle="modal" href="#myModal1"><button class="btn btn-theme"  name="Add business_type"><i class="fa fa-plus" aria-hidden="true"></i>ADD business_type </button> </span></a>
                              </h3>                  
             <!--start action-->                   
            <!-- <div class="action_buttons">                     
               ...
               <div class="row mt">         
                ...
                <thead> 
                 ...
                 <th><i class="fa fa-facebook"></i> <a href="javascript:void(0);"> business type </a> </th>
               ...
               <?php if ($total_rows != 0) {
                  foreach ($business_type as $business_type) {
                    $encode_id = base64_encode($business_type['type_id']);?>                                             
                    <tr>                                                    
                     <td data-title="#"><?php echo $business_type['type_id']; ?> </td>                           
                     <td data-title="business type"><?php echo $business_type['business_type']; ?></td> 
                     <td data-title="Status">
                                                        ...
                                                        if ($business_type['status'] == 1) {
                                                            ...
                                                            <button class="btn btn-primary btn-xs"><a href="<?php echo site_url('business_type/change_status/' . $business_type['type_id'] . '/0'); ?>" style='color:#fff;'>Active</a></button>
                                                            ...
                                                            <button class="btn btn-primary btn-xs"><a href="<?php echo site_url('business_type/change_status/' . $business_type['type_id'] . '/1'); ?>" style='color:#fff;'>Not Active</a></button>
                      ...
                      <td data-title="Action">
                        <a data-toggle="modal" href="#myModal-<?php echo $business_type['type_id']; ?>">
                         <button class="btn btn-primary btn-xs"><i class="fa fa fa-check"></i>
                         </button></a>

                         <a onClick="if (!confirm('Do you really 
                         want to delete business_type?')) {
                                     return false; }" 
                                     href="<?php echo site_url('business_type/delete/' . $encode_id); ?>">
                       ...
                       <!-- Modal -->                     
                    <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal-<?php echo $business_type['type_id']; ?>" class="modal fade">
                      ...
                      <div class="modal-body" style="margin-bottom:10px;">     
                       <div class="col-sm-3">                                           
                         ...
                         <?php  $form_attr = array('name' => 'business_type_form', 'id' => 'business_type_form');  echo form_open('business_type/edit', $form_attr); ?>
                           <div class="col-sm-9">                    
                           <input type="hidden" value="<?php echo $business_type['type_id']; ?>" name="type_id"  autocomplete="off" class="form-control placeholder-no-fix">            
                           <input type="text" value="<?php echo $business_type['business_type']; ?>" name="business_type"  autocomplete="off" class="form-control placeholder-no-fix">                           
                             </div>                                          
                           <div class="col-sm-3">                        
                       ...
                       <div class="modal-header">                            
                       <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                       <h4 class="modal-title">ADD business type</h4>                                                 </div>                                                      
                      <div class="modal-body" style="margin-bottom:10px;">     
                       <div class="col-sm-3">                                           
                         <p>business type</p>                                                           
                         </div>                                                           
                         <?php  $form_attr = array('name' => 'add_form', 'id' => 'add_form');  echo form_open('business_type/add', $form_attr); ?>
                           <div class="col-sm-9">                                
                           <input type="text" value="" name="business_type"  autocomplete="off" class="form-control placeholder-no-fix">                           
                             </div>                                          
                           <div class="col-sm-3">                        
                           <input type="submit" class="btn btn-theme" name="submit" value="Submit" />    </div>                                
                           </form>                                               
