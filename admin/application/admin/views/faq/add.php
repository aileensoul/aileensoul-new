                    ...
                    <div class="row mt">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-panel">
                                ...
                                echo form_open_multipart('faq/add', $form_attr);
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        <input type="text" id="faq_que" name="faq_que" value="" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        <input type="text" id="faq_ans" name="faq_ans" value="" class="form-control">
