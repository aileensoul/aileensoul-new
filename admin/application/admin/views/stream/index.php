    ...
    <body>
        ...
        <section id="container" >
            ...
            <section id="main-content">
                ...
                <li class="active">degree stream management</li>

                 </ol>

                    <!-- end breadcumb -->

                    <h3><i class="fa fa-angle-right"></i> <?php echo $module_name; ?> <span class="add_button"><a href="<?php echo site_url('stream/add') ?>" title="Add user">
                            ...
                            <div class="content-panel">
                                ...
                                <div class="search_box">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <?php echo form_open('stream/search', array('method' => 'post', 'id' => 'search_frm', 'class' => 'form-inline')); ?>
                                    ...
                                    <?php if ($this->session->userdata('user_search_keyword')) { ?>
                                        ...
                                        <a href="<?php echo site_url('stream/clear_search') ?>">Clear Search</a>
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                         ...
                                         <th><i class="fa fa-bullhorn"></i>  #  </th>
                                            ...
                                            <?php echo ( $this->uri->segment(3) == 'stream_id' && $this->uri->segment(4) == 'ASC' ) ? '<i class="glyphicon glyphicon-arrow-up">' : (( $this->uri->segment(3) == 'stream_id' && $this->uri->segment(4) == 'DESC' ) ? '<i class="glyphicon glyphicon-arrow-down">' : '' ); ?> 

                                            </th>

                                          

                                            <th><i class="fa fa-user"></i> <a href="<?php echo ( $this->uri->segment(3) == 'stream_name' && $this->uri->segment(4) == 'ASC') ? site_url($this->uri->segment(1) . '/' . $segment2 . '/stream_name/DESC/' . $offset) : site_url($this->uri->segment(1) . '/' . $segment2 . '/stream_name/ASC/' . $offset); ?>"> Stream Name </a>

                                                <?php echo ( $this->uri->segment(3) == 'stream_name' && $this->uri->segment(4) == 'ASC' ) ? '<i class="glyphicon glyphicon-arrow-up">' : (( $this->uri->segment(3) == 'stream_name' && $this->uri->segment(4) == 'DESC' ) ? '<i class="glyphicon glyphicon-arrow-down">' : '' ); ?> 
                                    ...
                                    <tbody>
                                        ...
                                        if ($total_rows != 0) {
                                            ...
                                            foreach ($stream_list as $stream) {
                                                ...
                                                $stream_encode_id = base64_encode($stream['stream_id']);
                                                ...
                                                <tr>
                                                    ...
                                                    <td data-title="Name"><?php echo $stream['stream_name']; ?></td>
                                                     ...
                                                     <td data-title="Status">
                                                        ...
                                                        if ($stream['status'] == 1) {
                                                            ...
                                                            <button class="btn btn-primary btn-xs"><a href="<?php echo site_url('stream/change_status/' . $stream['stream_id'] . '/0'); ?>" style='color:#fff;'>Active</a></button>
                                                            ...
                                                            <button class="btn btn-primary btn-xs"><a href="<?php echo site_url('stream/change_status/' . $stream['stream_id'] . '/1'); ?>" style='color:#fff;'>Not Active</a></button>
                                                    ...
                                                    <td data-title="Edit">
                                                        ...
                                                        <a href="<?php echo site_url('stream/edit/' . $stream_encode_id); ?>">
                                                        ...
                                                        <a onClick="if (!confirm('Do you really want to delete admin?')) {
                                                                        ...
                                                                        }" href="<?php echo site_url('stream/delete/' . $stream_encode_id); ?>"><button class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></button></a>
