        ...
        <section id="container" >
            ...
            <section id="main-content">
                ...
                <li class="active">Business management</li>
                    ...
                    <h3><i class="fa fa-angle-right"></i> <?php echo $module_name; ?> <span class="add_button"><a href="<?php echo site_url('business_management/add') ?>" title="Add Recruiter"><button name="Add User" class="btn btn-theme"><i class="fa fa-plus" aria-hidden="true"></i> Add Business</button></a></span> </h3>
                            ...
                            <div class="content-panel">
                                ...
                                <div class="search_box">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <?php echo form_open('business_management/search', array('method' => 'post', 'id' => 'search_frm', 'class' => 'form-inline')); ?>
                                    ...
                                    <?php if ($this->session->userdata('user_search_keyword')) { ?>
                                        ...
                                        <a href="<?php echo site_url('business_management/clear_search') ?>">Clear Search</a>
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                         ...
                                         <th><i class="fa fa-bullhorn"></i>  #  </th>
                                            ...
                                            <th class="hidden-phone"><i class="fa fa-envelope"></i> <a href="<?php echo ( $this->uri->segment(3) == 'admin_email' && $this->uri->segment(4) == 'ASC') ? site_url($this->uri->segment(1) . '/' . $segment2 . '/admin_email/DESC/' . $offset) : site_url($this->uri->segment(1) . '/' . $segment2 . '/admin_email/ASC/' . $offset); ?>"> Company Number </a>
                                    ...
                                    <tbody>
                                        ...
                                        if ($total_rows != 0) {
                                            ...
                                            foreach ($business_list as $business) {
                                                ...
                                                $encode_id = base64_encode($business['business_profile_id']);
                                                ...
                                                <tr>
                                                    ...
                                                    <!-- <td data-title="Image"><img src="<?php //echo base_url() . '../uploads/users/main/' . $user['admin_image'] ?>" alt="<?php //echo $user['admin_name']; ?>"  width="100px" height="80px"></td> -->
                                                     ...
                                                     <td data-title="Company Name "><?php echo $business['company_name']; ?></td>

                                                    <td data-title=" Company Email" class="mail_id"> &nbsp;<?php echo $business['contact_email']; ?></td>
                                                    <td data-title=" Company Email" class="mail_id"> &nbsp;<?php echo $business['contact_mobile']; ?></td>
                                                    

                                                    <td data-title="View">

                                                    <button class="btn btn-primary btn-xs"><a href="<?php echo site_url('business_management/show/'.$encode_id ); ?>" style='color:#fff;'>View</a></button>
                                                        </td>
                                                    ...
                                                    <td data-title="Status">
                                                        ...
                                                        if ($business['status'] == 1) {
                                                            ...
                                                            <button class="btn btn-primary btn-xs"><a href="<?php echo site_url('business_management/change_status/' . $business['business_profile_id'] . '/0'); ?>" style='color:#fff;'>Active</a></button>
                                                            ...
                                                            <button class="btn btn-primary btn-xs"><a href="<?php echo site_url('business_management/change_status/' . $business['business_profile_id'] . '/1'); ?>" style='color:#fff;'>Not Active</a></button>
                                                    ...
                                                    <td data-title="acion">
                                                        ...
                                                        <a href="<?php echo site_url('business_management/edit/' . $encode_id); ?>"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>

                                                        <a onClick="if (!confirm('Do you really want to delete Business?')) {

                                                                            return false;

                                                                        }" href="<?php echo site_url('business_management/delete/' . $encode_id); ?>"><button class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></button></a>
