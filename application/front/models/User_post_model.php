...
//        }
        ...
        $this->db->where("FIND_IN_SET('" . $keywordJobTitle . "',uo.opportunity_for) OR FIND_IN_SET('" . $keywordCity . "',uo.location) OR uo.opportunity LIKE '%$searchKeyword%' OR us.city = '$keywordCity' OR up.designation = '$keywordJobTitle'"
                . " OR up.field = '$keywordFieldList' OR us.university_name = '$keywordUniversityList' OR us.current_study = '$keywordDegreeList'");
