                ...
                if ($row['freelancer_post_user_image']) {
                    if (IMAGEPATHFROM == 'upload') {
                        if (!file_exists($this->config->item('free_post_profile_main_upload_path') . $row['freelancer_post_user_image'])) {
                            ...
                            $return_html .= '<a style="margin-right: 4px;" href="' . base_url('freelancer-work/freelancer-details/' . $row['freelancer_apply_slug']) . '" title=" ' . ucwords($row['freelancer_post_fullname']) . ' ' . ucwords($row['freelancer_post_username']) . '">';
                ...
                $return_html .= '</div></div>
                                                                    <div class="designation_rec" style="float: left;">
                                                                        <ul>
                                                                            <li>';
                if ($userid) {
                    $return_html .= '<a style="margin-right: 4px;" href="' . base_url('freelancer-work/freelancer-details/' . $row['freelancer_apply_slug']) . '" title="' . ucwords($row['freelancer_post_fullname']) . ' ' . ucwords($row['freelancer_post_username']) . '"><h6>';
                ...
                <p class="pull-right">';
                    ...
                    if ($this->session->userdata('aileenuser')) {
                        ...
                        if ($free_work_result) {
                            ...
                            $return_html .= '<a href="' . base_url('freelancer-work/basic-information') . '"    class= "btn4 savedpost">Save</a>';

                            $return_html .= '<a href="' . base_url('freelancer-work/basic-information') . '"  class= "btn4 applypost">Apply</a>';
                        }
                    } else {
