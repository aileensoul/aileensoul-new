...
//FOR PROGRESSBAR COUNT COMMON FUNCTION END
    ...
    public function header_all_dropdown_list() {
        $return_html = '<ul><li><div class="all-down"> <a href="'.base_url('job').'"> <div class="all-img"> <img src="'.base_url('assets/img/i1.jpg') .'"> </div><div class="text-all"> Job Profile </div></a> </div></li><li> <div class="all-down"> <a href="'.base_url('recruiter').'"> <div class="all-img"> <img src="'. base_url('assets/img/i2.jpg') .'"> </div><div class="text-all"> Recruiter Profile </div></a> </div></li><li> <div class="all-down"> <a href="'. base_url('freelancer') .'"> <div class="all-img"> <img src="'. base_url('assets/img/i3.jpg') .'"> </div><div class="text-all"> Freelance Profile </div></a> </div></li><li> <div class="all-down"> <a href="'. base_url('business-profile') .'"> <div class="all-img"> <img src="'. base_url('assets/img/i4.jpg') .'"> </div><div class="text-all"> Business Profile </div></a> </div></li><li> <div class="all-down"> <a href="'. base_url('artist') .'"> <div class="all-img"> <img src="'. base_url('assets/img/i5.jpg').'"> </div><div class="text-all"> Artist Profile </div></a> </div></li></ul>';
