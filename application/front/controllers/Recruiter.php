        ...
        if ($candidatejob) {
            foreach ($candidatejob1 as $row) {
                ...
                if (file_exists($imagee) && $row['job_user_image'] != '') {
                    ...
                    $postdata .= '<img src="' . REC_PROFILE_THUMB_UPLOAD_URL . $row['job_user_image'] . '" alt="' . $row[0]['fname'] . ' ' . $row[0]['lname'] . '">';
                    $postdata .= '</a>';
                } else {
            ...
            foreach ($searchdata1 as $p) {
                ...
                if (file_exists($imageee) && $p['job_user_image'] != '') {
                    ...
                    $return_html .= '<a href="' . base_url('job/resume/' . $p['slug'] . '?page=recruiter') . '" title="' . $p['fname'] . ' ' . $p['lname'] . '"> 
                                    <img src="' . REC_PROFILE_THUMB_UPLOAD_URL . $p['job_user_image'] . '" alt="' . $p[0]['fname'] . ' ' . $p[0]['lname'] . '">
                                    </a>';
                } else {
            ...
            foreach ($savedata1 as $rec) {
                ...
                if ($userdata[0]['status'] != 1) {
                    ...
                    if (file_exists($imageee) && $rec['job_user_image'] != '') {
                        ...
                        $return_html .= '<img src="' . REC_PROFILE_THUMB_UPLOAD_URL . $rec['job_user_image'] . '" alt="' . $rec[0]['fname'] . ' ' . $rec[0]['lname'] . '"></a>';
                    } else {
