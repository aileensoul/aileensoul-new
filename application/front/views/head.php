...
<script src="<?php  echo base_url('js/jquery-3.2.1.min.js?ver='.time()); ?>"></script> <!-- for all -->
<script src="<?php  echo base_url('js/jquery-ui.min-1.12.1.js?ver='.time()); ?>"></script> <!-- for search -->
