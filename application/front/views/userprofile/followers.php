...
<!--                                                            <div class="custom-user-btn" ng-if="follow.follow_user_id != null" id="Following-{{follow.user_id}}">
									<a class="btn3"   ng-click="unfollow_user(follow.user_id)">Following</a>
								</div>
                                                            <div class="custom-user-btn" ng-if="follow.follow_user_id == null" id="Follow-{{follow.user_id}}">
									<a class="btn3" ng-click="follow_user(follow.user_id)">Follow</a>
								</div>-->
