                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                <div class="right-box">
                                    ...
                                    <div class="btns">
                                        <a title="Take me in"  ng-if="details_data.bp_step == '4'" class="btn-4" ng-click="goMainLink('<?php echo base_url('business-profile'); ?>')">Take me in</a> 
                                        <a title="Take me in" ng-if="details_data.bp_status == '0' && details_data.rp_step == '3'" class="btn-4" ng-click="goMainLink('<?php echo base_url('business-profile'); ?>')">Active</a> 
                                        <a title="Take me in" ng-if="details_data.bp_step == null" class="btn-4" ng-click="goMainLink('<?php echo base_url('business-profile'); ?>')">Register</a> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <div class="right-box">
                                    ...
                                    <div class="btns">
                                        <a title="Take me in"  ng-if="details_data.jp_step == '10'" class="btn-4" ng-click="goMainLink('<?php echo base_url('job'); ?>')">Take me in</a> 
                                        <a title="Take me in" ng-if="details_data.jp_status == '0' && details_data.jp_step == '10'" class="btn-4" ng-click="goMainLink('<?php echo base_url('job'); ?>')">Active</a> 
                                        <a title="Take me in" ng-if="details_data.jp_step == null" class="btn-4" ng-click="goMainLink('<?php echo base_url('job'); ?>')">Register</a> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                <div class="right-box">
                                    ...
                                    <div class="btns">
                                       <a title="Take me in"  ng-if="details_data.rp_step == '3'" class="btn-4" ng-click="goMainLink('<?php echo base_url('recrutier'); ?>')">Take me in</a> 
                                        <a title="Take me in" ng-if="details_data.rp_status == '0' && details_data.rp_step == '3'" class="btn-4" ng-click="goMainLink('<?php echo base_url('recrutier'); ?>')">Active</a> 
                                        <a title="Take me in" ng-if="details_data.rp_step == null" class="btn-4" ng-click="goMainLink('<?php echo base_url('recrutier'); ?>')">Register</a> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <div class="right-box">
                                    ...
                                    <div class="btns">
                                        <a title="Take me in"  ng-if="details_data.ap_step == '4'" class="btn-4" ng-click="goMainLink('<?php echo base_url('artist'); ?>')">Take me in</a> 
                                        <a title="Take me in" ng-if="details_data.ap_status == '0' && details_data.ap_step == '4'" class="btn-4" ng-click="goMainLink('<?php echo base_url('artist'); ?>')">Active</a> 
                                        <a title="Take me in" ng-if="details_data.ap_step == null && details_data.ap_step == null" class="btn-4" ng-click="goMainLink('<?php echo base_url('artist'); ?>')">Register</a> 
