                        ...
                        <li class="dropdown all">
                            ...
                            <div class="dropdown-menu">
                                <div class="dropdown-title">
                                    Profiles <a ng-click="goMainLink('<?php echo base_url('profiless/' . $userdata['user_slug']); ?>')" class="pull-right">All</a>
                                </div>
...
<?php if (count($is_userBasicInfo) != 0) { ?>	
            ...
            <div class="main-user-option">
                <ul>
                    <li><a href="profiless/<?php echo $userdata['user_slug']; ?>"  ng-click='makeActive("profiless")' ng-class="{
                            'active': active == 'profiless'}">Profiles</a></li>
                    <li><a href="dashboardd/<?php echo $userdata['user_slug']; ?>"  ng-click='makeActive("dashboard")' ng-class="{
