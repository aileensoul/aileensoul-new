                            ...
                            foreach ($getFreelancers as $key => $value) {
                                ...
                                <div class="smap-catbox">
                                    ...
                                    <ul class="catbox-right">
                                        ...
                                        <li><a href="<?php echo base_url('freelance-work/freelance-details/' . $freelancers['freelancer_apply_slug']) ?>" target="_blank"><?php echo $freelancers['freelancer_post_fullname'] . ' ' .$freelancers['freelancer_post_username'] ; ?></a></li>    
                                        <?php } ?>
                                    </ul>
                                </div>
                                <?php
