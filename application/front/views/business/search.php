                    ...
                    <div class="all-job-box search-business" ng-repeat="business in categoryBusinessList">
                        <div class="search-business-top">
                            <div class="bus-cover no-cover-upload">
                                <a href="#" ng-if="business.profile_background"><img ng-src="<?php echo BUS_BG_MAIN_UPLOAD_URL ?>{{business.profile_background}}"></a>
                                <a href="#" ng-if="!business.profile_background"><img ng-src="<?php echo BASEURL.WHITEIMAGE ?>"></a>
                            </div>
                            <div class="all-job-top">
                                <div class="post-img">
                                    <a href="#" ng-if="business.business_user_image"><img ng-src="<?php echo BUS_PROFILE_THUMB_UPLOAD_URL ?>{{business.business_user_image}}"></a>
                                    <a href="#" ng-if="!business.business_user_image"><img ng-src="<?php echo BASEURL.NOBUSIMAGE ?>"></a>
                                </div>
                                <div class="job-top-detail">
                                    <h5><a href="#" ng-bind="business.company_name"></a></h5>
                                    <h5 ng-if="business.industry_name"><a href="#" ng-bind="business.industry_name"></a></h5>
                                    <h5 ng-if="!business.industry_name"><a href="#" ng-bind="business.other_industrial"></a></h5>
                                </div>
                            </div>
                        </div>
                        <div class="all-job-middle">
                            <ul class="search-detail">
                                <li ng-if="business.contact_website"><span class="img"><img class="pr10" ng-src="<?php echo base_url('assets/n-images/website.png') ?>"></span> <p class="detail-content"><a href="#" ng-bind="business.contact_website"></a></p></li>
                                ...
                                <li ng-if="business.details"><span class="img"><img class="pr10" ng-src="<?php echo base_url('assets/n-images/exp.png') ?>"></span><p class="detail-content">{{business.details | limitTo:110}}...<a href="#"> Read more</a></p></li>
                            </ul>
                        </div>
                    </div>
                </div>
