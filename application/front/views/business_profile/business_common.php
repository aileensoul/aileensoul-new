                        ...
                        <div class="profile-main-box-buis-menu">  
                            ...
                            <ul class="current-user bpro-fw6">
                                ...
                                <ul class="bpro-fw">
                                    ...
                                    <li <?php if ($this->uri->segment(1) == 'business-profile' && $this->uri->segment(2) == 'followers') { ?> class="active" <?php } ?>><a title="Followers" href="<?php echo base_url('business-profile/followers/' . $business_common_data[0]['business_slug']); ?>">Followers <br>  (<?php echo $business_user_follower_count; ?>)</a></li>
