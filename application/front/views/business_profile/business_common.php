                        ...
                        if ($business_common_data[0]['user_id'] == $userid) {
                            ...
                            <?php } else { ?>
                                ...
                                if ($business_common_data[0]['user_id'] == $userid) {
                                    ...
                                    <li <?php if ($this->uri->segment(1) == 'business-profile' && $this->uri->segment(2) == 'contacts') { ?> class="active" <?php } ?>><a title="Details" href="<?php echo base_url('business-profile/contacts/' . $business_common_data[0]['business_slug']); ?>"> Contacts <br>  (<span class="contactcount"><?php echo (count($businesscontacts)); ?></span>)</a>
                                    </li>
                                    ...
                                    <li <?php if ($this->uri->segment(1) == 'business_profile' && $this->uri->segment(2) == 'bus_contact') { ?> class="active" <?php } ?>><a title="Details" href="<?php echo base_url('business_profile/bus_contact/' . $business_common_data[0]['business_slug']); ?>"> Contacts <br>  (<?php echo (count($businesscontacts1)); ?>)</a>
                                    </li>
                                ...
                                ?> 
                                    <!-- <li <?php if ($this->uri->segment(1) == 'business-profile' && $this->uri->segment(2) == 'userlist') { ?> class="active" <?php } ?>><a title="Userlist" href="<?php echo base_url('business-profile/userlist/' . $business_common_data[0]['business_slug']); ?>">Userlist<br> (<?php echo (count($userlistcountbus)); ?>)</a></li> -->

                                <?php
                                $userid = $this->session->userdata('aileenuser');
                                if ($business_common_data[0]['user_id'] == $userid) {
                                    ?> 
                                    <li <?php if ($this->uri->segment(1) == 'business-profile' && $this->uri->segment(2) == 'followers') { ?> class="active" <?php } ?>><a title="Followers" href="<?php echo base_url('business-profile/followers/' . $business_common_data[0]['business_slug']); ?>">Followers <br>  (<?php echo (count($businessfollowerdata)); ?>)</a></li>
                                    <?php
                                } else {
                                    ...
                                    ?> 
                                    <li <?php if ($this->uri->segment(1) == 'business-profile' && $this->uri->segment(2) == 'followers') { ?> class="active" <?php } ?>><a title="Followers" href="<?php echo base_url('business-profile/followers/' . $business_common_data[0]['business_slug']); ?>">Followers <br>  (<?php echo (count($followerotherdata)); ?>)</a></li>
                                <?php } ?>
                                <?php
                                $userid = $this->session->userdata('aileenuser');
                                if ($business_common_data[0]['user_id'] == $userid) {
                                    ?>          
                                    <li <?php if ($this->uri->segment(1) == 'business-profile' && $this->uri->segment(2) == 'following') { ?> class="active" <?php } ?>><a title="Following" href="<?php echo base_url('business-profile/following/' . $business_common_data[0]['business_slug']); ?>">Following <br> <div id="countfollow">(<?php echo (count($businessfollowingdata)); ?>)</div></a>
                                    </li>
                                    <?php
                                } else {
                                    $businessregid = $business_common_data[0]['business_profile_id'];
                                    ...
                                    $followerotherdata = $this->data['followerotherdata'] = $this->common->select_data_by_condition('follow', $contition_array, $data = '*', $sortby = '', $orderby = '', $limit = '', $offset = '', $join_str = array(), $groupby = '');
                                    ?>
                                    <li <?php if ($this->uri->segment(1) == 'business-profile' && $this->uri->segment(2) == 'following') { ?> class="active" <?php } ?>><a title="Following" href="<?php echo base_url('business-profile/following/' . $business_common_data[0]['business_slug']); ?>">Following <br> (<?php echo (count($followerotherdata)); ?>)</a>
                                    </li>
                                <?php } ?>
                            </ul>
                            <?php
