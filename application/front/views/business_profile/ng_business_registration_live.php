    ...
    <body class="page-container-bg-solid page-boxed pushmenu-push reg-form botton_footer">
        ...
        <section>
            ...
            <?php } else { ?>
                    ...
                    <div class="container" ng-app="busRegApp" ng-controller="busRegController">
                        <div class="row">
...
<!--                                    <div class="form-group gender-custom">
                                    ...
                                    <p>
                                        ...
                                        <input type="submit" tabindex="13" name="submit" id="submit" value="Create an account" />
                                    </p>
                                </form>
        ...
        <script>
            ...
            var busRegApp = angular.module('busRegApp', ['ngValidate', 'ui.bootstrap.modal']);
            ...
            busRegApp.controller('busRegController', function ($scope, $http) {
                ...
                /* registration popup code start */
                if (profile_login == 'live') {
                    $('#register').modal('show');
                }
                
                $scope.registrationValidate = {
                    rules: {
                        companyname: {
                            required: true,
