            ...
            <div class="" id="paddingtop_fixed">
                ...
                <script type="text/javascript">
                    function new_chat(from) {
                        ...
                        $.getJSON('<?php echo base_url() . 'api/get_click_messages/'?>'+ from +'<?php echo '/' . $message_from_profile . '/' . $message_to_profile . '/' . $message_from_profile_id . '/' . $message_to_profile_id ?>?timestamp=' + request_timestamp, function (data) {
                            alert(data);
                            append_chat_data(data);
