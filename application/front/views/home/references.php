	...
	<div class="main-content">
		...
		<div class="panel panel-piluku">
			...
			<div class="panel-body">
				 <?php echo form_open(base_url('home/references_insert'), array('id' => 'references','name' => 'references')); ?>
					<?php
					...
					<div>
						<label>References:</label>
							<div>
					<textarea id="references"  name="references" placeholder="Put Your references"></textarea><br/><br/>
						</div>
						<?php echo form_error('references'); ?><br/><br/>
					</div>
						<div class="col-md-3">
							<input type="submit" id="submitreferences" name="submitreferences" value="save"><br/><br/>
						</div>
