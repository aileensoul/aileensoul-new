        ...
        <div class="padding_less main_art" >   <!-- Tab panes -->
                    <div class="top-tab">
                      <ul class="nav nav-tabs tabs-left remove_tab">
                          <li> <a href="<?php echo base_url('artist/photos/'.$artisticdata[0]['slug']) ?>"><i class="fa fa-camera" aria-hidden="true"></i>   Photos</a></li>
                          <li class="active"> <a href="<?php echo base_url('artist/videos/'.$artisticdata[0]['slug']) ?>"><i class="fa fa-video-camera" aria-hidden="true"></i>  Video</a></li>
                          <li><a href="<?php echo base_url('artist/audios/'.$artisticdata[0]['slug']) ?>"><i class="fa fa-music" aria-hidden="true"></i>  Audio</a></li>
                          <li>    <a href="<?php echo base_url('artist/pdf/'.$artisticdata[0]['slug']) ?>"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>  Pdf</a></li>
                        </ul>
                    </div>
