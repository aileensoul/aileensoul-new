                           ...
                           <?php echo form_open(base_url('artist/art_basic_information_insert'), array('id' => 'artbasicinfo','name' => 'artbasicinfo', 'class' => 'clearfix')); ?>
                               ...
                               <fieldset <?php if($firstname) {  ?> class="error-msg" <?php } ?>>
                                ...
                                <fieldset class="hs-submit full-width">                                 
                                   ...
                                   <button id="next" name="next" tabindex="5" onclick="return reg_loader();">Next<span class="ajax_load pl10" id="profilereg_ajax_load"><i aria-hidden="true" class="fa fa-spin fa-refresh"></i></span></button>
                                    </fieldset>
                           </form>
                        </div>
                    </div>
