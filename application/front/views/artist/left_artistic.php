               ...
               <div class="profile-boxProfileCard-content clearfix">
                  ...
                  <div class="right_left_box_design ">
                     ...
                     <ul class=" left_box_menubar">
                        ...
                        <li <?php if ($this->uri->segment(1) == 'artistic' && $this->uri->segment(2) == 'following') { ?> class="active" <?php } ?>><a class="padding_less_right"  title="Following" href="<?php echo base_url('artist/following'); ?>">Following<br><div id="countfollow">(<?php echo $countfr; ?>)</div></a>
                        </li>
                     </ul>
                  </div>
               </div>
