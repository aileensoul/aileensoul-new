             ...
             <ul class="current-user pro-fw">
                 ...
                 <ul class="pro-fw4">
                   <?php } ?>  
                    ...
                    if ($artisticdata[0]['user_id'] == $userid) {
                      ...
                      $countdata[] =  $artaval;
                       ...
                       $count = count($countdata);
                        ...
                        ?> 
                        <li <?php if ($this->uri->segment(1) == 'artistic' && $this->uri->segment(2) == 'followers') { ?> class="active" <?php } ?>><a  title="Followers" href="<?php echo base_url('artist/followers/' . $artisticdata[0]['slug']); ?>">Followers <br> (<?php echo ($count); ?>)</a>
                        </li>
                    ...
                    if ($artisticdata[0]['user_id'] == $userid) {
                        ?>        
                        <li <?php if ($this->uri->segment(1) == 'artistic' && $this->uri->segment(2) == 'following') { ?> class="active" <?php } ?>><a title="Following" href="<?php echo base_url('artist/following'); ?>">Following <br> <div id="countfollow">(<?php echo $countfr; ?>)</div></a>
                        </li>
                        <?php
                    } else {
                      ...
                      $countfo[] =  $artaval;
                       ...
                       $countfo = count($countfo);
                        ...
                        ?>
                        <li <?php if ($this->uri->segment(1) == 'artistic' && $this->uri->segment(2) == 'following') { ?> class="active" <?php } ?>><a title="Following" href="<?php echo base_url('artist/following/' . $artisticdata[0]['slug']); ?>">Following <br>  (<?php echo $countfo; ?>)</a>
                        </li> 
                    <?php } ?>  
