        ...
        <div class="padding_less main_art" >   <!-- Tab panes -->
                    <div class="top-tab">
                      <ul class="nav nav-tabs tabs-left remove_tab">
                          <li> <a href="<?php echo base_url('artistic/photos/'.$artisticdata[0]['user_id']) ?>"><i class="fa fa-camera" aria-hidden="true"></i>   Photos</a></li>
                          <li class="active"> <a href="<?php echo base_url('artistic/videos/'.$artisticdata[0]['user_id']) ?>"><i class="fa fa-video-camera" aria-hidden="true"></i>  Video</a></li>
...
<script type="text/javascript" src="<?php echo base_url('js/webpage/artistic/videos.js?ver='.time()); ?>"></script>
 </body>
</html>
