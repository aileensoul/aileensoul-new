        ...
        <div class="padding_less main_art" >
                        <div class="top-tab">
                            <ul class="nav nav-tabs tabs-left remove_tab">
                                ...
                                <li class="active">    <a href="<?php echo base_url('artistic/pdf/'.$artisticdata[0]['user_id']) ?>"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>  Pdf</a></li>
                              </ul>
                        </div>
          <!-- Tab panes -->
...
<script type="text/javascript" src="<?php echo base_url('js/webpage/artistic/pdf.js?ver='.time()); ?>"></script>
</body>
</html>