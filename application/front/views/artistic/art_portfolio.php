...
<div id="preloader"></div> -->
 ...
 <label for="bestofmine"  tabindex="1" ><i class="fa fa-plus action-buttons btn-group"  aria-hidden="true" style=" margin: 8px; cursor:pointer ; color: #fff; float: initial;"> </i> Attachment</label> <span id="datav" class="attach-file-name"></span><div class="portfolioloader">     
               </div>
