    ...
    <div class="modal-dialog modal-lm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <span class="mes">
                    <div id="popup-form">
 <form id ="userimage" name ="userimage" class ="clearfix" enctype="multipart/form-data" method="post">                        <input type="file" name="profilepic" accept="image/gif, image/jpeg, image/png" id="profilepic">
...
<script type="text/javascript" src="<?php echo base_url('js/webpage/artistic/details.js?ver='.time()); ?>"></script>
 </body>
</html>
