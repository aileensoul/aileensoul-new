                            ...
                            <div class="col-md-3 col-sm-3">
                                <div class="left-side-bar">
                                    <ul class="left-form-each">
                                        ...
                                        <li <?php if ($this->uri->segment(1) == 'freelancer-work') { ?> class="active init" <?php } ?>><a title="Avability" href="javascript:void(0);"><?php echo $this->lang->line("add_avability"); ?></a></li>
