                        ...
                        <div class="col-md-3 col-sm-3">
                            <div class="left-side-bar">
                                <ul class="left-form-each">
                                    ...
                                    <li <?php if ($this->uri->segment(1) == 'freelancer-work') { ?> class="active init" <?php } ?>><a title="Professional Information" href="#"><?php echo $this->lang->line("professional_info"); ?></a></li>
