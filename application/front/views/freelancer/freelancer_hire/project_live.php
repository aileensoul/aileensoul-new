                        ...
                        <div class=" right-side-menu art-side-menu padding_less_right right-menu-jr">  
                            ...
                            if ($freelancr_user_data[0]['user_id'] == $userid) {
                                ...
                                <?php } else { ?>
                                    ...
                                    <?php if (($this->uri->segment(1) == 'freelancer-hire') && ($this->uri->segment(2) == 'project-list' || $this->uri->segment(2) == 'employer-details' || $this->uri->segment(2) == 'add-projects' || $this->uri->segment(2) == 'freelancer-save') && ($this->uri->segment(3) == $this->session->userdata('aileenuser') || $this->uri->segment(3) != '')) { ?>
