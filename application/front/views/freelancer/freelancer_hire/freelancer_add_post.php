...
<span id="fullname-error"></span>
        ...
        <!-- Model Popup Close -->
        <!-- Calender JS Start-->
        <script async src="<?php echo base_url('assets/js/jquery.date-dropdowns.js?ver=' . time()); ?>"></script>
        <!-- Calender Js End-->
...
//                var city = document.getElementById('city').value;
        ...
        <script async type="text/javascript" src="<?php echo base_url('assets/js/webpage/freelancer-hire/freelancer_add_post.js?ver=' . time()); ?>"></script>
