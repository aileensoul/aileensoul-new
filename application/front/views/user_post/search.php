        ...
        <div class="middle-section">
            <div class="container">
                ...
                <div class="middle-part">
                    <div class="no-data-box" ng-if="searchProfileData.profile.length == '0'">
                    ...
                    <div class="availabel-data-box" ng-if="searchProfileData.profile.length != '0'">
                    ...
                    <div class="availabel-data-box" ng-if="searchProfileData.profile.length != '0'">
                        ...
                        <div class="search-profiles" ng-repeat="searchProfile in searchProfileData">
                            ...
                            <div class="profile-data">
                                <p><a href="<?php echo base_url('profile') ?>" ng-bind="searchProfile.fullname | capitalize"></a></p>
