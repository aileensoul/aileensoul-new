...
<html lang="en" class="custom-main">
    <head>
        ...
        <!--for advertise given by dhavalbhai date:14/11/2017 start-->
        <meta name="propeller" content="ce50d9fb6da358bfbedd86ab0b7dd36d" />
        <!--for advertise given by dhavalbhai date:14/11/2017 end-->
        <?php
