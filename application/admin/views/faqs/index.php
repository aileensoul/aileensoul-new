                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class=" pull-right">
                            <a href="<?php echo site_url('faqs/add'); ?>" class="btn btn-primary pull-right">Add Faqs</a>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                foreach ($faqs_list as $faqs) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $faqs['create_date'] ?></td>
                                        <td><?php echo $faqs['modify_date'] ?></td>
                                        <td><a href="<?php echo base_url() . 'faqs/edit/' . $faqs['id']; ?>" id="edit_btn" title="Edit Faqs">
                                                <button type="button" class="btn btn-primary"><i class="icon-pencil"></i> <i class="fa fa-pencil-square-o"></i></button>
                                            </a>
                                            <a data-href="<?php echo base_url() . 'faqs/delete/' . $faqs['id']; ?>" id="delete_btn" data-toggle="modal" data-target="#confirm-delete" href="#" title="Delete Faqs">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Are you sure want to delete this faqs?
            </div>
