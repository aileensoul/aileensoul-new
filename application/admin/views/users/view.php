                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group col-sm-10">
                            <label for="username" name="user_name" id="page_title">Full Name</label>
                            <input type="text" class="form-control" name="name" id="name" value="<?php echo $users_detail[0]['full_name']; ?>" readonly="readonly" />
                        </div>
                        <!-- user name end -->
                        <!-- user name start -->
                        <div class="form-group col-sm-10">
                            <label for="username" name="user_name" id="page_title">User Name</label>
                            <input type="text" class="form-control" name="name" id="name" value="<?php echo $users_detail[0]['user_name']; ?>" readonly="readonly" />
                        </div>
                        <!-- user name end -->
                        <!-- user name start -->
                        <div class="form-group col-sm-10">
                            <label for="username" name="user_name" id="page_title">Email Address</label>
                            <input type="text" class="form-control" name="name" id="name" value="<?php echo $users_detail[0]['email_addres']; ?>" readonly="readonly" />
                        </div>
                        <!-- user name end -->
                        <!-- user name start -->
                        <div class="form-group col-sm-10">
                            <label for="username" name="user_name" id="page_title">Age</label>
                            <input type="text" class="form-control" name="name" id="name" value="<?php echo $users_detail[0]['age']; ?>" readonly="readonly" />
                        </div>
                        <!-- user name end -->
                        <!-- user name start -->
                        <div class="form-group col-sm-10">
                        ...
                        <!-- user name start -->
                        <div class="form-group col-sm-10">
                            <label for="username" name="user_name" id="page_title">Country</label>
                            <input type="text" class="form-control" name="name" id="name" value="<?php echo $users_detail[0]['country']; ?>" readonly="readonly" />
                        </div>
                        <!-- user name end -->
                        <!-- user name start -->
                        <div class="form-group col-sm-10">
