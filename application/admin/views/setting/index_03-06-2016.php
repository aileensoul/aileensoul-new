                             ...
                             <tbody>
                                ...
                                //    pre($setting_list);
                                    foreach ($setting_list as $setting) { ?>
                                        ...
                                        <a href="#myModal" id="edit_btn" onclick="edit_setting('<?php echo $settingid; ?>');" data-toggle="modal">
                                         <button type="button" class="btn btn-primary"><i class="icon-pencil"></i> Edit</button>
                                        </a>
                                                
                                                
<!--                                                <a href="<?php echo base_url() . 'setting/edit/' . $setting['setting_id']; ?>" id="edit_btn">
                                                    <button type="button" class="btn btn-primary"><i class="icon-pencil"></i> Edit</button>
                                                </a>-->
                                            </td>
                                        </tr>
...
<script type="text/javascript">
   ...
   function validate_submit(e)
   {
      ...
      else
      {
          ...
          {
              var filter  = /^(?:(ftp|http|https):\/\/)?(?:[\w-]+\.)+[a-z]{3,6}$/;
              if(!filter.test($('#setting_val').val()))
              {
                  $("#errorMsg").hide();
                  $('#setting_val').parent().addClass('has-error');
