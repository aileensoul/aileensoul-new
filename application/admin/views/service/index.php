        ...
        <div class="row">
            <div class="col-xs-12" >
                <div class="box-tools pull-left">
                    <?php echo form_open('service/search', array('method' => 'post', 'id' => 'search_frm')); ?>
                ...
                <div class="col-sm-2 pull-left">
                   ...
                   <a href="<?php echo base_url('service/clear_search'); ?>" >
            ...
            ?>
                ...
                <div class=" pull-right">
                    <a href="<?php echo site_url('service/add'); ?>" class="btn btn-primary pull-right">Add Service</a>
                </div>
            </div>
        </div>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: left;">
                                        <a class="text-white" href="<?php echo ( $this->uri->segment(3) == 'service_title' && $this->uri->segment(4) == 'ASC') ? site_url($this->uri->segment(1) . '/'.$segment2.'/service_title/DESC/' . $offset) : site_url($this->uri->segment(1) . '/'.$segment2.'/service_title/ASC/' . $offset); ?>" title=""> Service Name
                                        </a>
                                        <?php echo ( $this->uri->segment(3) == 'service_title' && $this->uri->segment(4) == 'ASC' ) ? '<i class="glyphicon glyphicon-arrow-up">' : (( $this->uri->segment(3) == 'service_title' && $this->uri->segment(4) == 'DESC' ) ? '<i class="glyphicon glyphicon-arrow-down">' : '' ); ?> 
                                    </th>
                                    
                                     <th style="text-align: left;">
                                        <a href="Javascript:void(0)"> Service Image
                                        </a>
                                    </th>
                             ...
                             <tbody>
                                <?php if (!empty($service_list)) { 
                                    ?>
                                <?php echo form_open('service/mdelete', array('method' => 'post', 'id' => 'search_frm')); ?>
                                    <?php foreach ($service_list as $service) {
                                        ?>
                                        <tr>
                                            <td>
                                                <input type="checkbox" name="deletes[]" id="deletes" class="deletes" value="<?php echo $service['serviceid'] ?>">
                                            </td>
                                            
                                            <td><?php echo $service['service_title'] ?></td>
                                             <td>
                                                <img src=" <?php echo $this->config->item("MAIN_SITE_URL")?>uploads/service/thumbs/<?php echo $service['serviceimage']; ?>" width='70' height="70">
                                            </td>
                                           
                                            <td>
                                                <a href="<?php echo base_url() . 'service/change_status/' . $service['serviceid'].'/'.$service['status'] ; ?>" id="edit_btn">
                                                <?php echo $service['status'] ?>
                                            </td>
                                            
                                            <td><?php echo $service['insertdatetime'] ?></td>
                                            
                                            <td>
                                                <a href="<?php echo base_url() . 'service/edit/' . $service['serviceid']; ?>" id="edit_btn">
                                                    <button type="button" class="btn btn-primary"><i class="icon-pencil"></i> Edit</button>
                                                </a>
                                                <a data-href="<?php echo base_url() . 'service/delete/' . $service['serviceid']; ?>" id="delete_btn" data-toggle="modal" data-target="#confirm-delete" href="#">
