                ...
                <div class="box box-info">
                    ...
                    <!-- form start -->
                     <?php
                        ...
                        ?>
                    <input type="hidden" name="emailid" id="id" value="<?php echo $emailtemplate_detail[0]['emailid']; ?>" />
                        <div class="box-body">
                            ...
                            <div class="form-group col-sm-10">
                                ...
                                <div class="col-sm-9">
                                    <?php echo $emailtemplate_detail['0']['vartitle'] ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-sm-10">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="subject" id="subject" value="<?php echo $emailtemplate_detail['0']['varsubject'] ?>">
                                </div>
                            </div>
...
//                                    
//                                    ?>
                                    <textarea id="variable" class="form-control"  cols="20" rows="2" name="variable"><?php echo $emailtemplate_detail[0]['variables']; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-sm-10">
                                ...
                                <div class="col-sm-9">
                                    <?php echo form_textarea(array('name' =>'emailformat','id'=>'emailformat','class'=>"ckeditor",'value'=>$emailtemplate_detail[0]['varmailformat'])); ?><br>
                                </div>
                            </div>
