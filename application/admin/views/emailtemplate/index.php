                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: left;">
                                        <a class="text-white" href="<?php echo ( $this->uri->segment(3) == 'vartitle' && $this->uri->segment(4) == 'ASC') ? site_url($this->uri->segment(1) . '/'.$segment2.'/vartitle/DESC/' . $offset) : site_url($this->uri->segment(1) . '/'.$segment2.'/vartitle/ASC/' . $offset); ?>" title=""> Title
                                        </a>
                             ...
                             <tbody>
                                <?php if (!empty($emailtemplate_list)) { 
                                        ...
                                        <tr>
                                           <td><?php echo $emailtemplate['vartitle'] ?></td>
                                           
                                           
                                          
                                            <td>
                                              
                                                <a href="<?php echo base_url() . 'emailtemplate/edit/' . $emailtemplate['emailid']; ?>" id="edit_btn" title="Edit Email Templates">
...
<script type="text/javascript">
   ...
   function validate_submit(e)
   {
      ...
      else
      {
          ...
          if($('#emailvartitle').text()==='Bet Earning(in %)')
          {
              $('#emailtemplate_val').parent().addClass('has-error');
          ...
          if($('#emailvartitle').text()==='Telephone No.')
          {
