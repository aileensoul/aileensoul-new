                           ...
                           <!-- page name start -->
                            ...
                            <div class="form-group col-sm-10">
                                <label for="inputEmail3" name="page_title" id="page_title">Description *</label>
                                    <?php  echo form_textarea(array('name' =>'description','id'=>'description editor1','class'=>"textarea", 'style' => 'width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;','value'=>$pages_detail[0]['description'])); ?><br>
                            </div>
