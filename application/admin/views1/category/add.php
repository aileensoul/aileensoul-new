                ...
                <div class="box box-info">
                    ...
                    <!-- form start -->
                     <?php
                        ...
                        echo form_open_multipart('category/add', $form_attr);
                        ?>
                        <div class="box-body">
...
<!--                            <div class="form-group col-sm-10">
                            ...
                            <div class="form-group col-sm-10" id="cat_image">
                                <label for="inputEmail3" class="col-sm-2 control-label">Category File *<br>(gif|jpg|png)</label>
                                <div class="col-sm-6">
                                    <input type="file" name="category" id="category_image"   />
                                </div>
                            </div>
