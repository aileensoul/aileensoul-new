                    ...
                    <div class="row mt">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-panel">
                                ...
                                $form_attr = array('name' => 'add_stream', 'id' => 'edit_stream', 'class' => 'form-horizontal style-form');

                                echo form_open_multipart('stream/edit_insert', $form_attr);
  ...
  <div class="form-group">
                                       ...
                                       <select name="degree_id" id="degree">
                                            ...
                                            if(count($stream) > 0){
                                                foreach($stream as $s){
                                          ?>
                                                <option value="<?php echo $s['degree_id']; ?>"><?php echo $s['degree_id']; ?></option>
                                           <?php }}
                                            ?>
                                        </select>
                                         </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        <input type="text" id="stream_name" name="stream_name" value="<?php echo $stream[0]['stream_name']; ?>" class="form-control">
                                ...
                                <input type="hidden" name="stream_id" value="<?php echo $stream[0]['stream_id']; ?>" />    
