        ...
        $.ajax({
            ...
            success: function (response)
            {
                if (response == "ok") {
                    ...
                    $('.biderror .mes').html("<div class='pop_content'>Dear Valuable User ,<br> You recently gave us some really helpful comments about our service.we hope that this will help you better.<br> We really appreciate the time you took to help us.thanks for being awesome User..!!</div>");
                     $('#bidmodal').modal('show');
